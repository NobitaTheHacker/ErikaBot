...
async def save_group(bot, message):
    ...
    if temp.ME in r_j_check:
        ...
        if message.chat.id in temp.BANNED_CHATS:
            ...
            buttons = [[
                InlineKeyboardButton('Support', url=f'https://t.me/ShadowSupport12')
            ]]
        ...
        if settings["welcome"]:
            for u in message.new_chat_members:
                ...
                video="https://telegra.ph/file/03691465baa774e46506d.mp4",                                               
                                                 ...
                                                 reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('🔥  ↭ 𝙼𝙰𝙸𝙽 𝙲𝙷𝙰𝙽𝙽𝙴𝙻 ↭  🔥', url='http://t.me/ShadowUpdates12') ],
                                                                                      [ InlineKeyboardButton('🔥  ↭ 𝙾𝚆𝙽𝙴𝚁 ↭  🔥', url='http://t.me/Sad_Nobita') ]
                                                                                    ] )
                )
